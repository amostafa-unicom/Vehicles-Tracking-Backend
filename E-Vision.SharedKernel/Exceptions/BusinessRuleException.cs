...
namespace E_Vision.SharedKernel.Exceptions
{
    /// <summary>
    ...
    public class BusinessRuleException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessRuleException"/> class with specified business rule name.
        /// </summary>
        /// <param name="ruleName">business rule name which is not satisfied.</param>
        public BusinessRuleException(string ruleName)
            : base(string.Format("The {0} business rule is not satisfied.", ruleName))
        {
        ...
        //Note : we can recieve rule name rather object 
        public BusinessRuleException(string entityName, string ruleName , string errorMessage, [CallerMemberName] string businessOperation = "")
            : base(errorMessage)
        {
            RuleName = businessOperation + ruleName;
